        ...
        >
          ...
          >
            <span
              ...
              style={{
                backgroundImage:
                  "linear-gradient(90deg, #f6e6a7, #D4AF37, #FFD700)",
          ...
          <div className="leading-tight">
            <div className="text-[12px] tracking-[0.35em] text-white/90">
            ...
            >
              {({ isActive }) => (
                <>
                  ...
                  {isActive && (
                    <span className="absolute -bottom-2 left-1/2 h-[2px] w-6 -translate-x-1/2 bg-[#D4AF37]" />
                  )}
                </>
              )}
            </NavLink>
